...
public class selectFileUDP extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					selectFileUDP frame = new selectFileUDP();
	...
	public selectFileUDP() {
		...
		JLabel lblSelectFileTo = new JLabel("Select File To Send (UDP)");
		...
		btnSend.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				clientActionUDP x= new clientActionUDP();
				try {
